...
class CandidateMission(models.Model):
    family_candidate_family = models.ForeignKey('FamilyCandidate', models.DO_NOTHING, primary_key=True)
    family_mission_mission = models.ForeignKey('FamilyMission', models.DO_NOTHING)
    ...
    class Meta:
        ...
        unique_together = (('family_candidate_family', 'family_mission_mission'),)
...
class FamilyCandidate(models.Model):
    ...
    product_tbl_product = models.ForeignKey('ProductTbl', models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'family_candidate'
        unique_together = (('family_id', 'product_tbl_product'),)
